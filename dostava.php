...
<head>
  ...
  <title>MINIKOM PLUS | Dostava</title>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text">
            <p>MINIKOM PLUS isporuku svojih proizvoda vrši na teritoriji Srbije u saradnji sa kurirskom službom “DExpress”.</p>
            <p>Radimo na tome da dostava naših proizvoda bude dostupna i u Republici Srpskoj i Federaciji BiH.</p>
            <p>Sva roba koja je na lageru a poručena do 12h radnim danom biće poslata istog dana. Vreme isporuke je uglavnom 24h.</p>
            <p>Kurirska služba ne dostavlja pakete vikendom.</p>
          </div>
        </div>
        <div class="row d-flex justify-content-center">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 image">
              <img src="/img/kurir.jpg" alt="" class="img-fluid">
            </div>
           
        </div>

        <div class="row d-flex justify-content-center">
            <a href="http://www.dexpress.rs/" target="_blanc">DExpress</a>
        </div>
        </div>
      </div>
    </section>
