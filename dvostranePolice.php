...
<head>
  ...
  <title>MINIKOM PLUS | Proizvodi | Dvostrane Police</title>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <img src="../img/dvostrana164.jpg" class="w-100 d-block h-100" alt="First slide">
          </div>
          <div class="carousel-item">
            <img src="../img/dvostrana348.jpg" class="w-100 d-block h-100" alt="Second slide">
          </div>
          <div class="carousel-item">
            <img src="../img/dvostrana400.jpg" class="w-100 d-block h-100" alt="Third slide">
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                  <h2>Dvostrane Police</h2>
                </div>
            </div>
          <div class="row">
            <div class="col-md-4">
                <div class="kutija-container">
                  <h3>Dvostrana polica 164 BCD</h3>
                  <img src="../img/Polica dvostrana 164 BCD sl3.jpg" alt="" class="img-fluid">
            ...
            <div class="col-md-4">
                <div class="kutija-container">
                    <h3>Dvostrana polica 348 BCD</h3>
                    <img src="../img/Dvostrana polica sa 348 kutija BCD.jpg" alt="" class="img-fluid">
                    <div class="kutija-body">
                      <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                      <div class="dimensions">
                        <!-- <p>Dužina: 170 mm</p> -->
                        <div class="price-police">
                            <p>60000,00 din <br> + <br> pdv</p> 
                          </div>
                        <p>Širina: 2500 mm</p>
                        <p>Visina: 1250 mm</p>
                      </div>
              ...
              <div class="col-md-4">
                  <div class="kutija-container">
                      <h3>Dvostrana polica 400 C</h3>
                      <img src="../img/Dvostrana polica 400  C.jpg" alt="" class="img-fluid">
                      <div class="kutija-body">
                        <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                        <div class="dimensions">
                          <!-- <p>Dužina: 190 mm</p> -->
                          <div class="price-police">
                            <p>50000,00 din <br> + <br> pdv</p> 
                          </div>
                          <p>Širina: 2400 mm</p>
                          <p>Visina: 1250 mm</p>
                        </div>
