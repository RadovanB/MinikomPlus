...
<head>
  ...
  <title>MINIKOM PLUS | Proizvodi | Klaser 16 Fioka</title>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <img src="../img/klaser16crvenislider.jpg" class="w-100 d-block h-100" alt="First slide">
          </div>
          <div class="carousel-item">
            <img src="../img/klaser16plavislider.jpg" class="w-100 d-block h-100" alt="Second slide">
          </div>
          <div class="carousel-item">
            <img src="../img/klaser16sivislider.jpg" class="w-100 d-block h-100" alt="Third slide">
          </div>
        </div>
  ...
  <section class="plasticne-kutije-pregled">
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
                <div class="kutija-container">
                    <h3>Klaser 16 fioka plavi</h3>
                    <img src="../img/klaser16plavi.jpg" alt="" class="img-fluid">
                    <div class="kutija-body">
                      <!-- <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div> -->
                      <div class="dimensions">
                      <div class="price">
              ...
              <div class="col-md-4">
                  <div class="kutija-container">
                      <h3>Klaser 16 fioka sivi</h3>
                      <img src="../img/klaser16sivi.jpg" alt="" class="img-fluid">
                      <div class="kutija-body">
                        <!-- <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div> -->
                        <div class="dimensions">
                        <div class="price">
