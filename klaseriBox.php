...
<head>
  ...
  <title>MINIKOM PLUS | Proizvodi | Klaseri Box</title>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <img src="../img/box2slider.jpg" class="w-100 d-block h-100" alt="First slide">
          </div>
          <div class="carousel-item">
            <img src="../img/box3slider.jpg" class="w-100 d-block h-100" alt="Second slide">
          </div>
          <div class="carousel-item">
            <img src="../img/box4slider.jpg" class="w-100 d-block h-100" alt="Third slide">
          </div>
          <div class="carousel-item">
            <img src="../img/box5slider.jpg" class="w-100 d-block h-100" alt="Third slide">
          </div>
          <div class="carousel-item">
            <img src="../img/box6slider.jpg" class="w-100 d-block h-100" alt="Third slide">
          </div>
          <div class="carousel-item">
            <img src="../img/box9slider.jpg" class="w-100 d-block h-100" alt="Third slide">
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
                <div class="kutija-container">
                  <h3>PB 3</h3>
                  <img src="../img/Box 3.JPEG" alt="" class="img-fluid">
                  <div class="kutija-body">
                    <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                    <div class="dimensions">
                    <div class="price">
                            <p>4930,00 din <br> + <br> pdv</p> 
                          </div>
                      <p>Dužina: 600 mm</p>
                      <p>Širina: 209 mm</p>
                      <p>Visina: 240 mm</p>
              ...
              <div class="col-md-4">
                  <div class="kutija-container">
                    <h3>PB 4</h3>
                    <img src="../img/Box 4.JPG" alt="" class="img-fluid">
                    <div class="kutija-body">
                      <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                      <div class="dimensions">
                      <div class="price">
                            <p>3717,33 din <br> + <br> pdv</p> 
                          </div>
                        <p>Dužina: 600 mm</p>
                        <p>Širina: 174 mm</p>
                        <p>Visina: 206 mm</p>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="kutija-container">
                <h3>PB 5</h3>
                <img src="../img/Box 5.jpg" alt="" class="img-fluid">
                <div class="kutija-body">
                  <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                  <div class="dimensions">
                  <div class="price">
                            <p>2841,66 din <br> + <br> pdv</p> 
                          </div>
                    <p>Dužina: 600 mm</p>
                    <p>Širina: 141 mm</p>
                    <p>Visina: 164 mm</p>
            ...
            <div class="col-md-4">
              <div class="kutija-container">
                <h3>PB 6</h3>
                <img src="../img/Box 6.JPG" alt="" class="img-fluid">
                <div class="kutija-body">
                  <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                  <div class="dimensions">
                  <div class="price">
                            <p>1635,00 din <br> + <br> pdv</p> 
                          </div>
                    <p>Dužina: 600 mm</p>
                    <p>Širina: 98 mm</p>
                    <p>Visina: 112 mm</p>
            ...
            <div class="col-md-4">
              <div class="kutija-container">
                <h3>PB 9</h3>
                <img src="../img/Box 9.jpg" alt="" class="img-fluid">
                <div class="kutija-body">
                  <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                  <div class="dimensions">
                  <div class="price">
                            <p>1305,00 din <br> + <br> pdv</p> 
                          </div>
                    <p>Dužina: 600 mm</p>
                    <p>Širina: 69 mm</p>
                    <p>Visina: 77 mm</p>
