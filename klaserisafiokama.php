...
<head>
  ...
  <title>MINIKOM PLUS | Proizvodi | Klaseri sa fiokama
  </title>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <img src="../img/K20M.jpg" class="w-100 d-block h-100" alt="First slide">
          </div>
          <div class="carousel-item">
            <img src="../img/K18S.jpg" class="w-100 d-block h-100" alt="Second slide">
          </div>
          <div class="carousel-item">
            <img src="../img/K29S.jpg" class="w-100 d-block h-100" alt="Third slide">
          </div>

          <div class="carousel-item">
              <img src="../img/K9M.jpg" class="w-100 d-block h-100" alt="Third slide">
            </div>

            <div class="carousel-item">
                <img src="../img/K38V.jpg" class="w-100 d-block h-100" alt="Third slide">
              </div>
    
              <div class="carousel-item">
                  <img src="../img/K60V.jpg" class="w-100 d-block h-100" alt="Third slide">
                </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
                <div class="kutija-container">
                    <h3>K-20 M</h3>
                    <img src="../img/K-20-Mopt.jpg" alt="" class="img-fluid">
                    <div class="kutija-body">
                      <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                      <div class="dimensions">
                      <div class="price">
              ...
              <div class="col-md-4">
                  <div class="kutija-container">
                      <h3>K-18 S</h3>
                      <img src="../img/K-18-Sopt.jpg" alt="" class="img-fluid">
                      <div class="kutija-body">
                        <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                        <div class="dimensions">
                        <div class="price">
                            <p>3750,00 din <br> + <br> pdv</p> 
                          </div>
                          <p>Dužina: 155 mm</p>
                          <p>Širina: 375 mm</p>
                          <p>Visina: 375 mm</p>
          ...
          <div class="col-md-4">
                  <div class="kutija-container">
                      <h3>K-29 S</h3>
                      <img src="../img/K-29-Sopt.jpg" alt="" class="img-fluid">
                      <div class="kutija-body">
                        <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                        <div class="dimensions">
                        <div class="price">
                ...
                <div class="col-md-4">
                  <div class="kutija-container">
                      <h3>K-40 S</h3>
                      <img src="../img/K-40-Sopt.jpg" alt="" class="img-fluid">
                      <div class="kutija-body">
                        <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                        <div class="dimensions">
                        <div class="price">
                ...
                <div class="col-md-4">
                    <div class="kutija-container">
                        <h3>K-16 V</h3>
                        <img src="../img/K-16-Vopt.jpg" alt="" class="img-fluid">
                        <div class="kutija-body">
                          <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                          <div class="dimensions">
                          <div class="price">
                            <p>5300,00 din <br> + <br> pdv</p> 
                          </div>
                            <p>Dužina: 155 mm</p>
                            <p>Širina: 375 mm</p>
                            <p>Visina: 555 mm</p>
          ...
          <div class="col-md-4">
                  <div class="kutija-container">
                      <h3>K-27 V</h3>
                      <img src="../img/K-27-Vopt.jpg" alt="" class="img-fluid">
                      <div class="kutija-body">
                        <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                        <div class="dimensions">
                        <div class="price">
                ...
                <div class="col-md-4">
                  <div class="kutija-container">
                      <h3>K-38 V</h3>
                      <img src="../img/K-38-Vopt.jpg" alt="" class="img-fluid">
                      <div class="kutija-body">
                        <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                        <div class="dimensions">
                        <div class="price">
                ...
                <div class="col-md-4">
                    <div class="kutija-container">
                        <h3>K-49 V</h3>
                        <img src="../img/K-49-Vopt.jpg" alt="" class="img-fluid">
                        <div class="kutija-body">
                          <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                          <div class="dimensions">
                          <div class="price">
            ...
            <div class="col-md-4">
                    <div class="kutija-container">
                        <h3>K-60 V</h3>
                        <img src="../img/K-60-Vopt.jpg" alt="" class="img-fluid">
                        <div class="kutija-body">
                          <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                          <div class="dimensions">
                          <div class="price">
