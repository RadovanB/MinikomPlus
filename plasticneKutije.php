...
<head>
  ...
  <title>MINIKOM PLUS | Proizvodi | Plastične Kutije
  </title>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <img src="../img/kutijaA.jpg" class="w-100 d-block h-100" alt="First slide">
          </div>
          <div class="carousel-item">
            <img src="../img/kutijaB.jpg" class="w-100 d-block h-100" alt="Second slide">
          </div>
          <div class="carousel-item">
            <img src="../img/kutijaC.jpg" class="w-100 d-block h-100" alt="Third slide">
          </div>

          <div class="carousel-item">
              <img src="../img/kutijaD.jpg" class="w-100 d-block h-100" alt="Third slide">
            </div>

            <div class="carousel-item">
                <img src="../img/kutijaE.jpg" class="w-100 d-block h-100" alt="Third slide">
              </div>
    
              <div class="carousel-item">
                  <img src="../img/kutijaF.jpg" class="w-100 d-block h-100" alt="Third slide">
                </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
                <div class="kutija-container">
                    <h3>Kutija tip B</h3>
                    <img src="../img/Kutija tip B.jpg" alt="" class="img-fluid">
                    <div class="kutija-body">
                      <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                      <div class="dimensions">
                      <div class="price">
                            <p>60,00 din <br> + <br> pdv</p> 
                          </div>
                        <p>Dužina: 170 mm</p>
                        <p>Širina: 100 mm</p>
                        <p>Visina: 70 mm</p>
              ...
              <div class="col-md-4">
                  <div class="kutija-container">
                      <h3>Kutija tip C</h3>
                      <img src="../img/Kutija tip C.jpg" alt="" class="img-fluid">
                      <div class="kutija-body">
                        <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                        <div class="dimensions">
                        <div class="price">
                            <p>75,00 din <br> + <br> pdv</p> 
                          </div>
                          <p>Dužina: 190 mm</p>
                          <p>Širina: 120 mm</p>
                          <p>Visina: 80 mm</p>
          ...
          <div class="row">
              <div class="col-md-4">
                  <div class="kutija-container">
                    <h3>Kutija tip D</h3>
                    <img src="../img/Kutija tip D.jpg" alt="" class="img-fluid">
                    <div class="kutija-body">
                      <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                      <div class="dimensions">
                      <div class="price">
                            <p>160,00 din <br> + <br> pdv</p> 
                          </div>
                        <p>Dužina: 230 mm</p>
                        <p>Širina: 140 mm</p>
                        <p>Visina: 120 mm</p>
              ...
              <div class="col-md-4">
                  <div class="kutija-container">
                      <h3>Kutija tip E</h3>
                      <img src="../img/Kutija tip E.jpg" alt="" class="img-fluid">
                      <div class="kutija-body">
                        <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                        <div class="dimensions">
                        <div class="price">
                            <p>290,00 din <br> + <br> pdv</p> 
                          </div>
                          <p>Dužina: 340 mm</p>
                          <p>Širina: 220 mm</p>
                          <p>Visina: 160 mm</p>
                ...
                <div class="col-md-4">
                    <div class="kutija-container">
                        <h3>Kutija tip F</h3>
                        <img src="../img/Kutija tip F.jpg" alt="" class="img-fluid">
                        <div class="kutija-body">
                          <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                          <div class="dimensions">
                          <div class="price">
                            <p>540,00 din <br> + <br> pdv</p> 
                          </div>
                            <p>Dužina: 490 mm</p>
                            <p>Širina: 320 mm</p>
                            <p>Visina: 180 mm</p>
