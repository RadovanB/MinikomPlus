...
<head>
  ...
  <title>MINIKOM PLUS | Proizvodi | Prenosivi Klaseri</title>
    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <img src="../img/klaserSslider.jpg" class="w-100 d-block h-100" alt="First slide">
          </div>
          <div class="carousel-item">
            <img src="../img/klaserDslider.jpg" class="w-100 d-block h-100" alt="Second slide">
          </div>
          <div class="carousel-item">
            <img src="../img/klaser13slider.jpg" class="w-100 d-block h-100" alt="Third slide">
          </div>
          <div class="carousel-item">
            <img src="../img/klaser20slider.jpg" class="w-100 d-block h-100" alt="Third slide">
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
                <div class="kutija-container">
                  <h3>Klaser D</h3>
                  <img src="/img/Klaser D.jpg" alt="" class="img-fluid">
                  <div class="kutija-body">
                    <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                    <div class="dimensions">
                    <div class="price">
                            <p>300,00 din <br> + <br> pdv</p> 
                          </div>
                      <p>Dužina: 370 mm</p>
                      <p>Širina: 220 mm</p>
                      <p>Visina: 70 mm</p>
              ...
              <div class="col-md-4">
                  <div class="kutija-container">
                    <h3>Klaser 13</h3>
                    <img src="/img/klaser box 13 (1).jpg" alt="" class="img-fluid">
                    <div class="kutija-body">
                      <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                      <div class="dimensions">
                      <div class="price">
                            <p>550,00 din <br> + <br> pdv</p> 
                          </div>
                        <p>Dužina: 325 mm</p>
                        <p>Širina: 245 mm</p>
                        <p>Visina: 50 mm</p>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="kutija-container">
                <h3>Klaser 18</h3>
                <img src="/img/klaser box 18 s3.jpg" alt="" class="img-fluid">
                <div class="kutija-body">
                  <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                  <div class="dimensions">
                  <div class="price">
                            <p>620,00 din <br> + <br> pdv</p> 
                          </div>
                    <p>Dužina: 420 mm</p>
                    <p>Širina: 295 mm</p>
                    <p>Visina: 60 mm</p>
            ...
            <div class="col-md-4">
              <div class="kutija-container">
                <h3>Klaser 20</h3>
                <img src="/img/klaser box 20 s.jpg" alt="" class="img-fluid">
                <div class="kutija-body">
                  <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                  <div class="dimensions">
                  <div class="price">
                            <p>660,00 din <br> + <br> pdv</p> 
                          </div>
                    <p>Dužina: 478 mm</p>
                    <p>Širina: 330 mm</p>
                    <p>Visina: 70 mm</p>
