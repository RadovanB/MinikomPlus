...
<head>
  ...
  <title>MINIKOM PLUS | Usluge</title>
...
<body>
  ...
  <h2 class="frame"><span>MINIKOM PLUS</span> Ostvarimo saradnju odmah <a href="/contact.php" class="btn">Kontakt</a></h2>
  </div>
  <!-- Carousel END -->
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="col-md-6 padding-bottom">
              <div class="image-box">
              <img src="/img/laseropt.jpg" alt="" class="img-fluid">
            </div>
            </div>
            <div class="col-md-6">
                <div class="image-box">
              <img src="/img/primena1.jpg" alt="" class="img-fluid">
                </div>
            </div>
          </div>
          <div class="row">
          <div class="col-md-6 padding-bottom">
              <div class="image-box">
              <img src="/img/primena2.jpg" alt="" class="img-fluid">
              </div>
            </div>
            <div class="col-md-6">
                <div class="image-box">
              <img src="/img/primena4.jpg" alt="" class="img-fluid">
                </div>
            </div>
          </div>
          </div>
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text">
             <p>Posedujemo CO laser radne površine 600x400 mm,snage 50 W.</p>
               <p>Prednost laserskog graviranja u odnosu na štampu se ogleda u tome što se mogu raditi i pojedinačni komadi po pristupačnoj ceni.</p> 
               <p>Ukoliko imate potrebu ili ideju za nečim što se može laserski gravirati ili seći slobodno nas kontaktirajte za saradnju.</p> 
               <p>Možemo vam ponuditi pločice za označavanje od graverske plastike ili graverske folije u raznim bojama i debljinama.</p> 
                <p>Za sve dodatne informacije slobodno nas kontaktirajte.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
              <h4>Primeri oznaka</h4>
            </div>
          </div>
          
          <div class="row padding-bottom">
            <div class="col-md-4 padding-bottom">
              <img src="/img/oznaka1.jpg" alt="Oznaka 1" class="img-fluid">
            </div>
            <div class="col-md-4 padding-bottom">
                <img src="/img/oznaka2.jpg" alt="Oznaka 1" class="img-fluid">
              </div>
              <div class="col-md-4">
                  <img src="/img/oznaka3.jpg" alt="Oznaka 1" class="img-fluid">
                </div>
          </div>

          <div class="row">
              <div class="col-md-4 padding-bottom">
                <img src="/img/oznaka4.jpg" alt="Oznaka 1" class="img-fluid">
              </div>
              <div class="col-md-4 padding-bottom">
                  <img src="/img/oznaka5.jpg" alt="Oznaka 1" class="img-fluid">
                </div>
                <div class="col-md-4">
                    <img src="/img/oznaka6.jpg" alt="Oznaka 1" class="img-fluid">
                  </div>
            </div>
