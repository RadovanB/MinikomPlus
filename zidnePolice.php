...
<head>
  ...
  <title>MINIKOM PLUS | Proizvodi | Zidne Police</title>
...
<body>
  ...
  <div class="slider container-fluid">
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
          ...
          <div class="carousel-item active">
            <img src="../img/zidnaPolicaA.jpg" class="w-100 d-block h-100" alt="First slide">
          </div>
          <div class="carousel-item">
            <img src="../img/zidnaPolicaB.jpg" class="w-100 d-block h-100" alt="Second slide">
          </div>
          <div class="carousel-item">
            <img src="../img/zidnaPolicaC.jpg" class="w-100 d-block h-100" alt="Third slide">
          </div>

          <div class="carousel-item">
              <img src="../img/zidnaPolicaABC.jpg" class="w-100 d-block h-100" alt="Third slide">
            </div>

            <div class="carousel-item">
                <img src="../img/zidnaPolicaABC1.jpg" class="w-100 d-block h-100" alt="Third slide">
              </div>
        </div>
    ...
    <!-- <h2 class="frame"><span>MINIKOM PLUS</span> Ostvarimo saradnju već danas <a href="contact.html" class="btn">Kontakt</a></h2> -->
  </div>
  <!-- Carousel END -->
 
  <section class="plasticne-kutije-pregled">
        <div class="container">
          <div class="row">
          ...
          <div class="row">
            <div class="col-md-4">
                <div class="kutija-container">
                  <h3>Zidna polica 20 A</h3>
                  <img src="../img/Zidna polica sa 20 kutija tip A.jpg" alt="" class="img-fluid">
                  <div class="kutija-body">
                    <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                    <div class="dimensions">
                      <!-- <p>Dužina: 120 mm</p> -->
                      <div class="price-police">
                            <p>2500,00 din <br> + <br> pdv</p> 
                          </div>
                      <p>Širina: 400 mm</p>
                      <p>Visina: 500 mm</p>
                    </div>
            ...
            <div class="col-md-4">
                <div class="kutija-container">
                    <h3>Zidna polica 20 B</h3>
                    <img src="../img/Zidna polica sa 20 kutija tip B.jpg" alt="" class="img-fluid">
                    <div class="kutija-body">
                      <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                      <div class="dimensions">
                        <!-- <p>Dužina: 170 mm</p> -->
                        <div class="price-police">
                            <p>3000,00 din <br> + <br> pdv</p> 
                          </div>
                        <p>Širina: 400 mm</p>
                        <p>Visina: 500 mm</p>
                      </div>
              ...
              <div class="col-md-4">
                  <div class="kutija-container">
                      <h3>Zidna polica 20 C</h3>
                      <img src="../img/Zidna polica sa 20 kutija tip C.jpg" alt="" class="img-fluid">
                      <div class="kutija-body">
                        <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                        <div class="dimensions">
                          <!-- <p>Dužina: 190 mm</p> -->
                          <div class="price-police">
                            <p>3600,00 din <br> + <br> pdv</p> 
                          </div>
                          <p>Širina: 500 mm</p>
                          <p>Visina: 500 mm</p>
                        </div>
          ...
          <div class="row">
              <div class="col-md-4">
                  <div class="kutija-container">
                    <h3>Zidna polica 42 ABC </h3>
                    <img src="../img/Zidna polica sa 42 kutije ABC s2.jpg" alt="" class="img-fluid">
                    <div class="kutija-body">
                      <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                      <div class="dimensions">
                        <!-- <p>Dužina: 230 mm</p> -->
                          <div class="price-police">
                              <p>6500,00 din <br> + <br> pdv</p> 
                            </div>
                        <p>Širina: 500 mm</p>
                        <p>Visina: 1000 mm</p>
                      </div>
              ...
              <div class="col-md-4">
                  <div class="kutija-container">
                      <h3>Zidna polica 84 ABC</h3>
                      <img src="../img/Zidna polica sa 84 kutije ABC.jpg" alt="" class="img-fluid">
                      <div class="kutija-body">
                        <span> Boja:</span><div class="red"></div> <div class="blue"></div> <div class="yellow"></div> <div class="grey"></div>
                        <div class="dimensions">
                          <!-- <p>Dužina: 340 mm</p> -->
                          <div class="price-police">
                            <p>13000,00 din <br> + <br> pdv</p> 
                          </div>
                          <p>Širina: 1000 mm</p>
                          <p>Visina: 1000 mm</p>
                        </div>
